        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <form onSubmit={handleQuoteSubmit} className="bg-white rounded-[40px] p-6 md:p-8 grid gap-4 shadow-2xl border border-black/10">
            ...
            <div className="bg-zinc-100 rounded-3xl p-5">
              ...
              <input ref={photoInputRef} name="photos" type="file" accept="image/*" multiple onChange={(e) => setFilesCount(e.target.files?.length || 0)} className="mt-3 w-full bg-zinc-950 text-white rounded-2xl px-5 py-4" />
