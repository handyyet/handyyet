  ...
  return (
    <main className="min-h-screen bg-[#f6f3ee] text-zinc-950">
      ...
      <section className="max-w-7xl mx-auto px-5 pb-24">
        <div className="bg-orange-500 rounded-[36px] p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-3xl md:text-5xl font-black tracking-tight">Ready to book?</h2>
            <p className="mt-3 text-black/70 text-lg">Send photos and get a fast quote.</p>
          </div>
          <a href="/#quote" className="bg-zinc-950 text-white px-8 py-5 rounded-full font-black text-lg whitespace-nowrap hover:scale-105 transition shadow-xl">
            Send Photos →
          </a>
        </div>
      </section>
